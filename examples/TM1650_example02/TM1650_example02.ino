...
byte bright = 3; // Default brightness of display
...
void setup() {
	...
	tm1650.displayChar(0, dig + '0', false);
	tm1650.displayChar(1, '-', false);
	tm1650.displayChar(2, 'H', false);
	tm1650.displayChar(3, 'I', false);
}
...
void loop() {
	...
	if (buttons == 0x4c) {
		if (!key2) {
			key2 = true;
			bright++;
			if (bright > TM1650_MAX_BRIGHT) bright = TM1650_MIN_BRIGHT;
			tm1650.setBrightness(bright);
		}
	} else {
		key2 = false;
